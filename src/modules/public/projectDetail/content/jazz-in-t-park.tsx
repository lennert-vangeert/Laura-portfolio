    ...
    <div className={styles.page}>
      ...
      <section className={styles.bandA}>
        <div className={styles.col}>
          <img src={img.insta} alt="Jazz in 't park — Instagram posts" className={styles.insta} />
          <p className={styles.intro}>{t("projects.jazz-in-t-park.intro")}</p>
        </div>
        <div className={styles.col}>
          <img src={img.echo} alt="Jazz in 't park — Echo Horizon poster" className={styles.echo} />
        </div>
      </section>
      ...
      <section className={styles.bandB}>
        <div className={styles.col}>
          <img src={img.sonic} alt="Jazz in 't park — Sonic Muse poster" className={styles.sonic} />
        </div>
        <div className={styles.col}>
          <img src={img.folderCover} alt="Jazz in 't park — festival folder" className={styles.folderCover} />
      ...
      <section className={styles.bandC}>
        <div className={styles.col}>
          <img src={img.jazzNova} alt="Jazz in 't park — Jazz Nova poster" className={styles.jazzNova} />
        </div>
        <div className={styles.col}>
          <img src={img.folderInner} alt="Jazz in 't park — folder programme" className={styles.folderInner} />
