  ...
  return (
    <div className={styles.page}>
      ...
      <section className={styles.band1}>
        <img src={img.cover} alt="Omleegvallers gazet — cover" className={styles.cover} />
        <div className={styles.band1right}>
          <div className={styles.smalls}>
            <img src={img.offfKaartFlat} alt="Offf op de kaart — spread" />
            <img src={img.wielen} alt="Een dag op wielen — spread" />
          </div>
      ...
      <section className={styles.band2}>
        <img src={img.zakdoek} alt="Een zakdoek groot — spread" />
        <img src={img.howto} alt="How to: zakdoekje leggen — spread" />
        <img src={img.kerk} alt="Impe — church spread" />
        <img src={img.karate} alt="Karate Kid: Rani — spread" />
      </section>

      {/* Band 3 — impe (2x2) + hand pic with nav beneath, bottom-right */}
      <section className={styles.band3}>
        <img src={img.impe} alt="Impe — map spread" className={styles.impe} />
        <div className={styles.band3right}>
          <img src={img.offfKaart} alt="Offf op de kaart — held spread" className={styles.hand} />
